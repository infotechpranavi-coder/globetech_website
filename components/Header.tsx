    ...
    <header className={`w-full z-50 transition-all duration-300 sticky top-0 ${isScrolled ? 'bg-white/95 backdrop-blur-sm shadow-md' : 'bg-white'}`}>
      ...
      <div className="border-b border-gray-100 py-1 sm:py-2">
        <div className="container mx-auto px-4 max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-2">
          {/* Tagline */}
          <div className="text-[10px] sm:text-xs md:text-sm font-bold text-globe-red uppercase tracking-widest">
          ...
          <div className="flex items-center divide-x divide-gray-200">
            ...
            <div className="flex items-center px-2 sm:px-4 gap-3 sm:gap-4">
              ...
              <Link href={socialLinks.twitter} target="_blank" className="text-gray-400 hover:text-globe-black transition-colors" title="X (Twitter)">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                </svg>
              </Link>
              <Link href={socialLinks.linkedin} target="_blank" className="text-gray-400 hover:text-[#0A66C2] transition-colors" title="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </Link>
              <Link href={socialLinks.instagram} target="_blank" className="text-gray-400 hover:text-[#E4405F] transition-colors" title="Instagram">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href={socialLinks.youtube} target="_blank" className="text-gray-400 hover:text-[#FF0000] transition-colors" title="YouTube">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-4">
              <div className="flex flex-col lg:flex-row lg:items-baseline lg:gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[9px] sm:text-[10px] md:text-xs font-bold text-gray-500 uppercase tracking-tight">
