    ...
    return (
        <main className="min-h-screen bg-white relative">
            ...
            <div className="fixed right-2 top-1/2 -translate-y-1/2 z-[100] flex flex-col bg-black/90 backdrop-blur-md rounded-full overflow-hidden border-2 border-globe-red shadow-[0_0_30px_rgba(239,68,68,0.3)]">
                ...
                <a href="https://maps.app.goo.gl/jHHZeweWktWefyRM6" target="_blank" className="p-4 hover:bg-globe-red transition-all group border-b border-white/5">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </a>
                <a href="mailto:support@globetechinnovations.com" className="p-4 hover:bg-globe-red transition-all group border-b border-white/5">
                ...
                <a href="https://wa.me/919323151641?text=I%20would%20like%20to%20enquire%20about%20your%20automation%20solutions." target="_blank" className="p-4 hover:bg-globe-red transition-all group border-b border-white/5">
                ...
                <a href="tel:9323151641" className="p-4 hover:bg-globe-red transition-all group">
                        ...
                        {quoteSuccess ? (
                            ...
                            <form 
                                onSubmit={async (e) => {
                                    ...
                                    } catch (error) { alert('Service Interruption. Contact Hotline: 9323151641'); }
